...
//初始化函数
$(function () {
    var seaSurVail = allSeaFunction();
    //加载地图
    seaSurVail.initSecMap("surVailMap",121.8,31.0883,-1);
    //获取左侧菜单的数据
     seaSurVail.getSiderbar("seaSurVailJson","seaEnvirStation");//加载页面左侧菜单以及默认显示的数据
    ...
    $('#toolBar li').click(function (e) {
        ...
        seaSurVail.ChangeDataExpress(dataTypeId);//改变展示的数据类型
    })
});